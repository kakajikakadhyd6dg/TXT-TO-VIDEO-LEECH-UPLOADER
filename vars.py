...
FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "agriculture supervisor")  # Channel username without @, 
FORCE_SUB_CHANNEL_LINK = environ.get("FORCE_SUB_CHANNEL_LINK", "https://t.me/+-Cuo_nCT-O1jMzNl")  # Channel link
